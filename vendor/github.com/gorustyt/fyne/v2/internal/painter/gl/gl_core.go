...
func (c *coreContext) GetUniformMatrix4fv(program Program, name string,)(res mgl32.Mat4) {
	gl.GetUniformfv(uint32(program),int32(c.GetUniformLocation(program, name)), &res[0])
	return
}
